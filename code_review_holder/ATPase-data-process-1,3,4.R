...
path_1 = "C:\\Users\\Luis\\Dropbox (MIT)\\Lab\\Experiments\\ATP hydrolysis by Orc1_Orc4\\Assays\\ATPase\\2020_09_03 ATPase Analysis of 4R supps\\2020_07_13 Orc3 P481L 4R\\2020_07_13 Orc3 P481L 4R ATPase.xlsx"
path_2 = "C:\\Users\\Luis\\Dropbox (MIT)\\Lab\\Experiments\\ATP hydrolysis by Orc1_Orc4\\Assays\\ATPase\\2020_09_03 ATPase Analysis of 4R supps\\2020_07_27 Orc3 P481L 4R #2/2020_07_27 Orc3 P481L 4R ATPase #2.xlsx"
path_3 = "C:\\Users\\Luis\\Dropbox (MIT)\\Lab\\Experiments\\ATP hydrolysis by Orc1_Orc4\\Assays\\ATPase\\2020_09_03 ATPase Analysis of 4R supps\\2020_08_13 Orc3 PL 4R #3 and Orc4 PS 4R/2020_08_13 Orc3 PL 4R #3 and Orc4 PS 4R #1.xlsx"
path_4 = "C:\\Users\\Luis\\Dropbox (MIT)\\Lab\\Experiments\\ATP hydrolysis by Orc1_Orc4\\Assays\\ATPase\\2020_09_03 ATPase Analysis of 4R supps\\2020_08_24 Orc4 PS 4R #2 and #3/2020_08_24 Orc4 PS 4R #2 and #3.xlsx"
path_5 = "C:\\Users\\Luis\\Dropbox (MIT)\\Lab\\Experiments\\ATP hydrolysis by Orc1_Orc4\\Assays\\ATPase\\2020_09_03 ATPase Analysis of 4R supps\\2020_09_21 Orc1 EK 4R/2020_09_21 Orc1 EK 4R.xlsx"
...
#The raw data is from ImageJ analysis. Values that could not be measured via ImageJ (no background basically)
#Were added manually to the excel sheet. 
###### First Experiment ######
...
atpase_data['Experiment'] <- as.factor('Exp 7')
...
atpase_data$Sample <- as.factor(atpase_data$Sample)
atpase_data['Experiment'] <- as.factor('Exp 8')
...
atpase_data$Sample[17] <- "No_ORC"
atpase_data$Sample <- as.factor(atpase_data$Sample)
atpase_data['Experiment'] <- as.factor('Exp 9')
...
atpase_data$Sample[17] <- "No_ORC"
atpase_data$Sample <- as.factor(atpase_data$Sample)
atpase_data['Experiment'] <- as.factor('Exp 10')
...
atpase_data$Sample[17] <- "No_ORC"
atpase_data$Sample <- as.factor(atpase_data$Sample)
atpase_data['Experiment'] <- as.factor('Exp 11')
...
atpase_data$Sample[17] <- "No_ORC"
atpase_data$Sample <- as.factor(atpase_data$Sample)
atpase_data['Experiment'] <- as.factor('Exp 12')
...
atpase_data$Sample[17] <- "No_ORC"
atpase_data$Sample <- as.factor(atpase_data$Sample)
atpase_data['Experiment'] <- as.factor('Exp 13')
...
all_experiments_df1 <- all_experiments_df
