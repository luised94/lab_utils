# -*- coding: utf-8 -*-
"""
Created on Mon Apr  6 13:29:27 2020
...
import os
os.chdir(r"C:\Users\liusm\Documents")
...
filename = 'Verified_ORF_info_' + today +'.xlsx'
f = open(filename, 'w')

#,UpstreamIntergenicStart,UpstreamIntergenicEnd,UpstreamIntergenicLength
header_string = 'SystematicName,GeneName,FullName,SGD_Alias,Phenotype,Chr,Genome_Start,Genome_End,Strand,Downstream_Intergenic_Start,Downstream_Intergenic_End,Upstream_Intergenic_Start,Upstream_Intergenic_End\n'
# count = 1
