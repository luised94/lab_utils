...
#USAGE: First, determine this by running the INITIALIZE_ARRAY, modify the array number. Then, from anywhere, run 'sbatch ~/data/lab_utils/next_generation_sequencing/test_001_filterFastq.sh <dir>'
#SETUP
DIR_TO_PROCESS="$1"
